Для получения ключа необходимо выполнить запрос к https://\*\*\*.galileo.com.ua/api/users/authorize, передав данные аутентификации приложения email и pass\_hash.
